...
![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) Time limit is 3 days.

![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) CORS Error:** if you get this error, it means you are calling the API directly from the client, which is not allowed due to the security reason. you should try to setup a simple server (nodejs or express etc) to handle the API calls.

![#c5f015](https://via.placeholder.com/15/c5f015/c5f015.png) Bonus: use nextjs and styled components
...
![#c5f015](https://via.placeholder.com/15/c5f015/c5f015.png) Make a Fork and Submit a pull request against this repository. 
